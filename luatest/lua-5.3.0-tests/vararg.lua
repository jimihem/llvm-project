--[[
-cc1 -fluamangle -no-round-trip-args  -undef -x lua -std=lua53 -emit-llvm -triple lua_v53-pc-luaInterp-itanium_elf  C:\llvm\src\luatest\lua-5.3.0-tests\vararg.lua
...
-cc1 -fluamangle -no-round-trip-args  -undef -x lua -std=lua53 -main-file-name vararg.lua -dwarf-version=5 -debugger-tuning=lldb -gsrc-hash=md5 -debug-info-kind=standalone -S -triple lua_v53-pc-luaInterp-itanium_elf  C:\llvm\src\luatest\lua-5.3.0-tests\vararg.lua
C:\llvm\src\luatest\lua-5.3.0-tests\vararg.o -o C:\llvm\src\luatest\lua-5.3.0-tests\vararg.out
-flavor ld -z undefs -pie C:\llvm\src\luatest\lua-5.3.0-tests\vararg.o -o C:\llvm\src\luatest\lua-5.3.0-tests\vararg.out
