...
enum RelExpr {
  ...
  R_LUAVM_GV_THUNK_IMM14_LS,
  R_LUAVM_GV_THUNK_IMM14_I,
  R_LUAVM_GV_THUNK_IMM32,
  R_LUAVM_GOT_GV_THUNK_IMM14_LS,
  R_LUAVM_GOT_GV_THUNK_IMM14_I,
  R_LUAVM_GOT_GV_THUNK_IMM32,
  R_LUAVM_CALL_THUNK,
  R_LUAVM_GOT_CALL_THUNK,
};
